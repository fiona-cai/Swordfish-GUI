...
from PyQt6.QtWidgets import QApplication as Application, QWidget as Widget, QPushButton as Button
from PyQt6.QtWidgets import QLabel as Label, QGridLayout, QDesktopWidget
